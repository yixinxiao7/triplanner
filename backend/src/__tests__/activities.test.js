...
describe('GET /api/v1/trips/:tripId/activities', () => {
  ...
  it('happy path: returns list of activities', async () => {
    ...
    const res = await request(buildApp(), 'GET', '/api/v1/trips/trip-1/activities', null, AUTH);
  ...
  it('error path: returns 401 without auth', async () => {
    const res = await request(buildApp(), 'GET', '/api/v1/trips/trip-1/activities', null);
  ...
  it('error path: returns 404 when trip not found', async () => {
    ...
    const res = await request(buildApp(), 'GET', '/api/v1/trips/nonexistent/activities', null, AUTH);
...
describe('POST /api/v1/trips/:tripId/activities', () => {
  ...
  it('happy path: creates activity and returns 201', async () => {
    const res = await request(buildApp(), 'POST', '/api/v1/trips/trip-1/activities', {
      name: "Fisherman's Wharf",
      location: "Fisherman's Wharf, SF",
      activity_date: '2026-08-08',
      start_time: '09:00',
...
describe('DELETE /api/v1/trips/:tripId/activities/:id', () => {
  ...
  it('happy path: deletes activity and returns 204', async () => {
    ...
    const res = await request(buildApp(), 'DELETE', '/api/v1/trips/trip-1/activities/activity-1', null, AUTH);
  ...
  it('error path: returns 404 when activity not found', async () => {
    ...
    const res = await request(buildApp(), 'DELETE', '/api/v1/trips/trip-1/activities/nonexistent', null, AUTH);
